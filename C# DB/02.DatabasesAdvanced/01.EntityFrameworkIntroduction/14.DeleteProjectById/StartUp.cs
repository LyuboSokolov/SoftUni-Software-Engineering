...
namespace SoftUni
{
    public class StartUp
    {
        ...
        {
            //context.Employees.Select(x=>  x.EmployeesProjects.Where(x=>x.ProjectId ==2));
            //var projects = context.Projects.Where(x => x.ProjectId == 2)
            //    .Select(ep => new
            //    {
            //        employeesProjects = ep.EmployeesProjects
            //    .Select(e => new
            //    {
            //        e.EmployeeId,
