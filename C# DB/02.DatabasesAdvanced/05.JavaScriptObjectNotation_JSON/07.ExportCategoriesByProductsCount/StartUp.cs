...
namespace ProductShop
{
    public class StartUp
    {
        ...
        // Problem Query 6. Export Successfully Sold Products
        ...
        //Provlem 7. Export Categories by Products Count
        public static string GetCategoriesByProductsCount(ProductShopContext context)
        {
            var categoriesProducts = context
                 .Categories
                 ...
                 .Select(x => new
                 {
                     ...
                     TotalRevenue = $"{x.CategoryProducts.Sum(pr => pr.Product.Price):f2}"
                 })
                 .ToList();
            ...
            var result = JsonConvert.SerializeObject(categoriesProducts, jsonSettings);
